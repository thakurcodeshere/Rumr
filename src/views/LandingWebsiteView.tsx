      ...
      <header className="sticky top-0 z-40 bg-[#0c0c0c]/95 backdrop-blur-md border-b-2 border-[#262626]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <a 
              href="#downloads" 
              className="inline-flex items-center gap-1.5 font-mono text-xs font-black bg-[#ccff00] text-black border-2 border-black px-3.5 py-2 shadow-[3px_3px_0px_#a855f7] hover:translate-x-0.5 hover:translate-y-0.5 transition-transform uppercase"
            >
              DOWNLOAD APP
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div id="downloads" className="pt-2 flex flex-wrap items-center gap-3">
                ...
                {/* iOS */}
                <button 
                  onClick={() => alert('iOS TestFlight Beta link is opening: Build 2.4.0')}
                  className="flex items-center gap-3 bg-[#121212] border-2 border-[#333] hover:border-[#ccff00] px-4 py-2.5 shadow-[4px_4px_0px_#a855f7] hover:translate-x-0.5 hover:translate-y-0.5 transition-transform group text-left"
                >
                  <svg className="w-7 h-7 fill-white group-hover:fill-[#ccff00] transition-colors" viewBox="0 0 384 512">
                    <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/>
                  </svg>
                  <div className="font-mono">
                    <span className="block text-[9px] text-gray-400 uppercase tracking-wider">DOWNLOAD ON THE</span>
                    <span className="block text-sm font-black text-white uppercase tracking-tight">Apple App Store</span>
                  </div>
                </button>

                {/* Android */}
                <button 
                  onClick={() => alert('Android APK / Play Store Open Beta is ready: Build 2.4.0')}
                  className="flex items-center gap-3 bg-[#121212] border-2 border-[#333] hover:border-[#ccff00] px-4 py-2.5 shadow-[4px_4px_0px_#ccff00] hover:translate-x-0.5 hover:translate-y-0.5 transition-transform group text-left"
                >
                  <svg className="w-7 h-7 fill-white group-hover:fill-[#ccff00] transition-colors" viewBox="0 0 512 512">
                    <path d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"/>
                  </svg>
                  <div className="font-mono">
                    <span className="block text-[9px] text-gray-400 uppercase tracking-wider">GET IT ON</span>
                    <span className="block text-sm font-black text-white uppercase tracking-tight">Google Play</span>
                  </div>
                </button>
                ...
                {onLaunchApp && (
                  <button 
                    onClick={onLaunchApp}
                    className="flex items-center gap-2 bg-[#ccff00] text-black border-2 border-black px-4 py-2.5 shadow-[4px_4px_0px_#a855f7] font-mono text-xs font-black uppercase hover:bg-white transition-colors"
                  >
                    <Zap className="w-4 h-4 fill-black" /> OPEN WEB TUNNEL
                  </button>
                )}
